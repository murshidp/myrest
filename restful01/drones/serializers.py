...
from drones.models import (
    DroneCategory,Drone,Pilot,Competition
)


class DroneCategorySerializer(serializers.HyperlinkedModelSerializer):
    drones = serializers.HyperlinkedRelatedField(many=True,read_only=True,view-name='drone-detail')
...
class DroneSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Drone
        fields = (
            'url','name','drone_category','manufacturing_date','has_it_completed','inserted_timestamp'
        )
